...
/* Created on:     11/3/2013 2:56:21 PM                         */
/*==============================================================*/
...
create table STAVKA_PROMETNOG_DOKUMENTA (
   ...
   constraint PK_STAVKA_PROMETNOG_DOKUMENTA primary key (PIB, GODINA, BROJ_PROMETNOG_DOKUMENTA, RBR)
)
go
...
alter table ANALITIKA_MAGACINSKE_KARTICE
   add constraint FK_ANALITIK_STAV_PRO__STAVKA_P foreign key (PIB, GODINA, BROJ_PROMETNOG_DOKUMENTA, RBR)
      references STAVKA_PROMETNOG_DOKUMENTA (PIB, GODINA, BROJ_PROMETNOG_DOKUMENTA, RBR)
go
...
alter table PROMETNI_DOKUMENT
   add constraint FK_PROMETNI_POSL_OBJ__POSLOVNI foreign key (PIB, POS_SIFRA_OBJEKTA)
      references POSLOVNI_OBJEKAT (PIB, SIFRA_OBJEKTA)
go
